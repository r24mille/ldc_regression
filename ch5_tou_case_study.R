...
#####
#subset.months <- c("m3", "m4", "m5", "m6", "m7", "m8", "m9", "m10")
#readings.subset <- subset(readings.trimmed, subset = month %in% subset.months)
#readings.subset$month <- factor(readings.subset$month, levels = subset.months)
...
#
# TODO(r24mille): Be careful about working this decision in the thesis. People 
#                 get touchy about p-values.
coeftest(tou.lm, vcov = hac.vcov)
...
# TODO(r24mille): Is there some way to use heterskedastic and autocorrelation 
